...
(defn valid-ns
  ...
  (s/conform ::ns
             (first
               (sp/select [spe/SEXPRS sp/ALL (sp/codewalker (fn [form]  (when (or (list? form) (vector? form)) (= 'ns  (first form)))))] self))))
...
{:form ns,
 ...
 :clauses [[:require {:clause :require,
                      :libs [[:lib clojure.string]
                             ...
                             [:prefix-list {:prefix com.rpl.specter, :refer {:as specter}}]
                             [:prefix-list {:prefix specter-edn.core, :refer {:as specter-edn}}]
                             [:prefix-list {:prefix clojure.core.specs.alpha, :refer {:as core-specs}}]
